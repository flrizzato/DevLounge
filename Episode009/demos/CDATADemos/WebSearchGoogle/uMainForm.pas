...
type
  TMainForm = class(TForm)
    ...
    imgSearch: TImage;
    WebSearchSearchTerms: TWideStringField;
    WebSearchTitle: TWideStringField;
    WebSearchHtmlTitle: TWideStringField;
    WebSearchLink: TWideStringField;
    WebSearchDisplayLink: TWideStringField;
    WebSearchSnippet: TWideStringField;
    WebSearchHtmlSnippet: TWideStringField;
    WebSearchFormattedUrl: TWideStringField;
    WebSearchHtmlFormattedUrl: TWideStringField;
    ImageSearchSearchTerms: TWideStringField;
    ImageSearchTitle: TWideStringField;
    ImageSearchHtmlTitle: TWideStringField;
    ImageSearchLink: TWideStringField;
    ImageSearchDisplayLink: TWideStringField;
    ImageSearchSnippet: TWideStringField;
    ImageSearchHtmlSnippet: TWideStringField;
    ImageSearchImageWidth: TIntegerField;
    ImageSearchImageHeight: TIntegerField;
    ImageSearchSize: TIntegerField;
    ImageSearchImageThumbnail: TWideStringField;
    ImageSearchImageContext: TWideStringField;
...
procedure TMainForm.BindSourceDB2SubDataSourceDataChange(Sender: TObject;
  Field: TField);
begin
  if not ImageSearchImageThumbnail.AsString.IsEmpty then
    imgSearch.Picture.LoadFromStream
      (LoadWebImage(ImageSearchImageThumbnail.AsString));
end;
