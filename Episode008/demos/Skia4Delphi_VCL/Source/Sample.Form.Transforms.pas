...
uses
  ...
  System.Math.Vectors, System.Rtti, Vcl.Graphics, Vcl.Controls, Vcl.Forms,
  Vcl.ExtCtrls,
...
type
  TfrmTransforms = class(TfrmBase)
    pnlTaperTransform: TPanel;
    lblTaperTransformDescription: TSkLabel;
    lblTaperTransformTitle: TSkLabel;
    svgTaperTransformArrow: TSkSvg;
    pnlTaperTransformLine: TPanel;
    pnlStrechedCorners: TPanel;
    lblStrechedCornersDescription: TSkLabel;
    lblStrechedCornersTitle: TSkLabel;
    svgStrechedCornersArrow: TSkSvg;
    pnlStrechedCornersLine: TPanel;
    pnl3DRotation: TPanel;
    lbl3DRotationDescription: TSkLabel;
    lbl3DRotationTitle: TSkLabel;
    svg3DRotationArrow: TSkSvg;
    pnl3DRotationLine: TPanel;
    procedure pnl3DRotationClick(Sender: TObject);
    procedure pnlStrechedCornersClick(Sender: TObject);
    procedure pnlTaperTransformClick(Sender: TObject);
  public
    { Public declarations }
  end;
...
procedure TfrmTransforms.pnl3DRotationClick(Sender: TObject);
var
...
procedure TfrmTransforms.pnlStrechedCornersClick(Sender: TObject);
const
  CornerButtonSize = 20;
  TouchExpansion = 5;
var
...
procedure TfrmTransforms.pnlTaperTransformClick(Sender: TObject);
var
  LOptions: IViewerOptions;
begin
  LOptions := TViewerOptions.Create;
