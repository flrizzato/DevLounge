inherited frmParticles: TfrmParticles
  PixelsPerInch = 96
  TextHeight = 15
  inherited pnlContent: TPanel
    ...
    inherited sbxContent: TScrollBox
      object pnlParticlesWithMouse: TPanel
        ...
        ShowCaption = False
        TabOrder = 0
        OnClick = pnlParticlesWithMouseClick
        DesignSize = (
          320
          50)
        object lblParticlesWithMouseDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 304
        ...
        object lblParticlesWithMouseTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 304
          ...
          Words = <
            item
              Caption = 'Particles With Mouse Iterations'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgParticlesWithMouseArrow: TSkSvg
          Left = 307
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlParticlesWithMouseLine: TPanel
          Left = 0
          Top = 49
          Width = 320
          Height = 1
      ...
      object pnlParticlesAssets: TPanel
        AlignWithMargins = True
        Left = 20
        Top = 71
        Width = 320
        ...
        ShowCaption = False
        TabOrder = 1
        OnClick = pnlParticlesAssetsClick
        DesignSize = (
          320
          50)
        object lblParticlesAssetsDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 304
          ...
          Words = <
            item
              Caption = 'See all particles examples in sample assets'
            end>
          ExplicitTop = 21
          ExplicitWidth = 278
        end
        object lblParticlesAssetsTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 304
          ...
          Words = <
            item
              Caption = 'Particles Assets'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgParticlesAssetsArrow: TSkSvg
          Left = 307
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlParticlesAssetsLine: TPanel
          Left = 0
          Top = 49
          Width = 320
          Height = 1
