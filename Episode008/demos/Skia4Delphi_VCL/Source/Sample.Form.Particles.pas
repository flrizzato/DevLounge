...
uses
  ...
  System.Diagnostics, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.ExtCtrls,
...
type
  TfrmParticles = class(TfrmBase)
    pnlParticlesWithMouse: TPanel;
    lblParticlesWithMouseDescription: TSkLabel;
    lblParticlesWithMouseTitle: TSkLabel;
    svgParticlesWithMouseArrow: TSkSvg;
    pnlParticlesWithMouseLine: TPanel;
    pnlParticlesAssets: TPanel;
    lblParticlesAssetsDescription: TSkLabel;
    lblParticlesAssetsTitle: TSkLabel;
    svgParticlesAssetsArrow: TSkSvg;
    pnlParticlesAssetsLine: TPanel;
    procedure pnlParticlesAssetsClick(Sender: TObject);
    procedure pnlParticlesWithMouseClick(Sender: TObject);
  public
    { Public declarations }
  end;
...
procedure TfrmParticles.pnlParticlesAssetsClick(Sender: TObject);
var
...
procedure TfrmParticles.pnlParticlesWithMouseClick(Sender: TObject);
const
