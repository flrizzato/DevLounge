...
uses
  ...
  Azure.API3.Speech.SpeechToText
    in '..\Source\Azure.API3.Speech.SpeechToText.pas',
  Azure.API3.Speech.TextToSpeech
    in '..\Source\Azure.API3.Speech.TextToSpeech.pas',
  Azure.API3.Speech.Voices in '..\Source\Azure.API3.Speech.Voices.pas',
  Azure.API3.Translator.Dictionary
    in '..\Source\Azure.API3.Translator.Dictionary.pas',
  Azure.API3.Translator.Languages
    in '..\Source\Azure.API3.Translator.Languages.pas',
  Azure.API3.Translator in '..\Source\Azure.API3.Translator.pas',
  frames.TranslateText
    in 'frames.TranslateText.pas' {FrameTranslateText: TFrame} ,
